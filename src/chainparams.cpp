...
{
    const char* pszTimestamp = "10/Dec/2017 Cboe Futures Exchange starts trading Bitcoin Futures";
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x6213f0e07c17e4ccef1fd9d023b06ce7e8bdbddaf2c4175197149302b7c351e8"));
        assert(genesis.hashMerkleRoot == uint256S("0x50d06cf115a47da37c547ccac1ad10b32c2c52a56a14af4fd32bc33cdea4455a"));
	...
	*/
	...
	base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,33);
        ...
        chainTxData = ChainTxData{
            ...
            1512851400, // * UNIX timestamp of last known number of transactions
            500,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1512861660, 819982, 0x1e0ffff0, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x63394026b8d87fc96ab9c9563281202134d4ce8107cab65daa96a39487a5121b"));
        assert(genesis.hashMerkleRoot == uint256S("0x50d06cf115a47da37c547ccac1ad10b32c2c52a56a14af4fd32bc33cdea4455a"));
	...
	*/
	...
	vFixedSeeds.clear();
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("63394026b8d87fc96ab9c9563281202134d4ce8107cab65daa96a39487a5121b")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1512863220, 0, 0x207fffff, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf57875190d2bb166f369f5f9e68f3312499863cca0da9d4ad410df52774806fe"));
        assert(genesis.hashMerkleRoot == uint256S("0x50d06cf115a47da37c547ccac1ad10b32c2c52a56a14af4fd32bc33cdea4455a"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("f57875190d2bb166f369f5f9e68f3312499863cca0da9d4ad410df52774806fe")},
            }
        };
